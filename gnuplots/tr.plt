...
GNUTERM = "wxt"
## Last datafile plotted: "c:\users\liuzx\desktop\data\data_simthreshold50"
plot 'c:\users\liuzx\desktop\data\data_simthreshold50' using 1:3 lc -1 lw 2
#    EOF
